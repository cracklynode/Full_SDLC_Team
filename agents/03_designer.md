...
## I/O Specification
- **Input:** `../outputs/02_Analyst_Output_Dossier.yaml`
- **Output:** `../outputs/03_Design_Output_Kit.yaml`
- **Working Context:** Translates the Analyst’s specifications into user interaction flows, interface layouts, and visual system guidance ensuring accessibility, usability, and functional alignment.
