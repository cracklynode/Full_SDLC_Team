...
## I/O Specification
- **Input:** 
  - `../outputs/04_Developer_Output_Package.yaml`
  - `../outputs/02_Analyst_Output_Dossier.yaml`
- **Output:** 
  - `../outputs/06_DevOps_Output_Package.yaml`
  - `../infra/` *(iaac/, pipelines/, monitoring/, security/)*
- **Working Context:** Designs and configures the operational environment, CI/CD pipelines, IaC templates, security policies, monitoring, and disaster recovery systems for reliable, scalable deployment.
